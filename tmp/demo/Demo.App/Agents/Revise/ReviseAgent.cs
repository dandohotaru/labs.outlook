...
{
    public class ReviseAgent
    {
        private IChatService Service { get; set; }

        public ReviseAgent(IChatService service)
        {
            Service = service ?? throw new ArgumentNullException(nameof(service));
        }

        public async Task<ReviseResult> Revise(DraftModel draft, IEnumerable<EmailModel> conversation)
        {
